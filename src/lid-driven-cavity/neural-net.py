...
def load_data_from_folders(folders):
    ...
    for folder in folders:
        ...
        try:
            ...
            # Columns: x-coordinate, y-coordinate, y-wall-shear, x-wall-shear
            ...
            # Combine data
            folder_data = np.column_stack([x_coord, y_coord, re_column, x_wall_shear, y_wall_shear])
...
# X: [x-coordinate, y-coordinate, Re]
# y: [x-wall-shear, y-wall-shear]
X_train = train_data[:, :3]  # x, y, Re
y_train = train_data[:, 3:]  # x-wall-shear, y-wall-shear
...
class SimpleNN(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(3, 64)   # Input: x, y, Re
